...
public class powercollision : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("Player"))
        {
            ...
            if (playerMovement != null)
            {
                ...
                {
                    playerMovement.PuntosMenosCorrutina();
                }
                else
                {
    ...
    //}
    //aplica el efecto y despues de ciertos segundos vuelve a la normalidad
    //public IEnumerator puntosmenos(PlayerMovement playerMovement)
    //{
    ...
    //    //playerMovement.photonView.RPC("SendScore", RpcTarget.All, playerMovement.contador);
