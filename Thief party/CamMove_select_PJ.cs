...
public class CamMove_select_PJ : MonoBehaviourPunCallbacks
{
    ...
    [Header("Sonidos")]
    public AudioSource RejaAbrir;
    public AudioSource RejaGolpear;
    ...
    IEnumerator Cinematica() // Esta corrutina controla toda la cinematica inicial de selección de personaje
    {
        ...
        iTween.ShakePosition(RejaShacke, new Vector3(0.05f, 0, 0), 3f);
        RejaGolpear.Play();
        ...
        iTween.MoveTo(RejaSubir, iTween.Hash("position", new Vector3(-5.898218f, 4.03499985f, -17.1325817f), "Time", 1.5f, "easetype", SmoothCam));
        RejaAbrir.Play();
